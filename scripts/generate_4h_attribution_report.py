...
def generate_report():
    ...
    with open(out_md, "w", encoding="utf-8") as f:
        ...
        if not df_ablation.empty:
            ...
            f.write(">    - 在三个固定退场对照中，唐奇安通道触发了更多交易笔数（多 24 至 26 笔），但其全周期**累计摩擦金额反而更低**（例如共享布林中轨下为 $15,750，低于布林带的 $20,333；无中轨止损退出下为 $15,709，低于布林带的 $23,178；Mode B 下为 $7,545，低于布林带的 $17,889）。这是因为手续费和滑点与账户名义权益成正比，当策略净值复合增长较低时，后续单笔交易的名义金额与摩擦绝对值更小。因此，**交易笔数更多绝不等于总摩擦金额更高**。\n")
