...
- **Report Updated / 报告更新时间**: `2026-09-23 12:09:05 UTC`
- **Evaluation Cutoff / 冻结基准线**: `2026-09-23 00:00:00 UTC`
- **Runner Regime / 运行模式**: `FORWARD_OOS_LIVE`
- **Total Genuine OOS Bars Tracked / 累计样本外真实 K 线**: `3` bars
- **Last Processed Bar / 最新闭合 K 线**: `2026-09-23 08:00:00+00:00`
...
| :--- | :--- | :--- | :--- |
| **Current Equity / 当前权益** | **$9,921.75 USDT** | **$9,914.42 USDT** | $+7.33 USDT |
| **Net Return / 累计净收益率** | **-0.78%** | **-0.86%** | **+0.07%** |
| **Max Drawdown / 最大回撤** | 0.78% | 0.86% | -0.07% |
...
- **Current Progress / 当前进度**: `0 / 30` completed roundtrips (3 live bars accumulated).
