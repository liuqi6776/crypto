...
- **Report Updated / 报告更新时间**: `2026-09-23 05:38:32 UTC`
- **Evaluation Cutoff / 冻结基准线**: `2026-09-23 00:00:00 UTC`
- **Runner Regime / 运行模式**: `DEMO_REPLAY`
- **Total Genuine OOS Bars Tracked / 累计样本外真实 K 线**: `20` bars
- **Last Processed Bar / 最新闭合 K 线**: `2026-09-22 20:00:00`
- **Anomalies Encountered / 触发异常次数**: `0` (Logged in journal)
...
| :--- | :--- | :--- | :--- |
| **Current Equity / 当前权益** | **$10,433.08 USDT** | **$10,455.52 USDT** | $-22.44 USDT |
| **Net Return / 累计净收益率** | **+4.33%** | **+4.56%** | **-0.22%** |
| **Max Drawdown / 最大回撤** | 2.58% | 2.49% | +0.09% |
...
| **Total Fees Paid / 手续费损耗** | $24.47 | $8.00 | $+16.47 |
| **Total Slippage / 滑点损耗** | $15.28 | $4.99 | $+10.29 |
...
- **Current Progress / 当前进度**: `1 / 30` completed roundtrips (20 live bars accumulated).
